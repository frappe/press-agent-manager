...
if TYPE_CHECKING:
	...
	from press_agent_manager.agent.doctype.agent_job.agent_job import AgentJob
	from press_agent_manager.agent.doctype.agent_job_step.agent_job_step import AgentJobStep
