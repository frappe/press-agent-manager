...
from press_agent_manager.workflow_engine.doctype.press_workflow.press_workflow import enqueue_workflow
...
def enqueue_task(task_name: str) -> None:
	if frappe.flags.in_test:
		from press_agent_manager.workflow_engine.test import foreground_enqueue_task
