...
if TYPE_CHECKING:
	from press_agent_manager.workflow_engine.doctype.press_workflow.press_workflow import (
		PressWorkflow,
	)
	from press_agent_manager.workflow_engine.doctype.press_workflow_test.press_workflow_test import (
		PressWorkflowTest,
	)
