...
from press_agent_manager.workflow_engine.doctype.press_workflow.exceptions import PressWorkflowTaskEnqueued
...
if TYPE_CHECKING:
	from press_agent_manager.workflow_engine.doctype.press_workflow.press_workflow import PressWorkflow
	from press_agent_manager.workflow_engine.doctype.press_workflow_kv.press_workflow_kv import (
		InMemoryKVStore,
		KVStoreInterface,
		WorkflowKVStore,
	)
	from press_agent_manager.workflow_engine.doctype.press_workflow_task.press_workflow_task import (
		PressWorkflowTask,
	)
...
class WorkflowBuilder(Document):
	...
	workflow_doc: PressWorkflow | None = None
